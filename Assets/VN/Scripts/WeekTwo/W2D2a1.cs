...
public class W2D2a1 : MonoBehaviour
{
    ...
    void Update()
    {
        //Debug.Log("null option?:" + string.IsNullOrEmpty(dialogueManager.selectedOption));
        ...
        {
            END = false;
            // Code to transition to the next scene/activity
            Debug.Log("End of dialogue sequence. Transitioning...");
        }
    }
}
