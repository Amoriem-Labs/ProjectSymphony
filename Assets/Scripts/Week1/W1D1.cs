...
public class W1D1 : MonoBehaviour
{
    ...
    public bool DP1_3 = false;
    public bool DP1_4 = false;
    public bool DP1_5 = false;
    public bool DP1_6 = false;
    public bool DP1_7 = false;
    public bool DP1_8 = false;
    public bool DP1_9 = false;
    bool END = false;
    ...
    void Update()
    {
        if (dialogueManager.isW1D1)
        {
            ...
            if (!string.IsNullOrEmpty(dialogueManager.selectedOption) && DP1_5)
            {
                ...
                if (currselectedOption == "I'm from Resonara.")
                {
                    DP1_6 = true;
                ...
                else if (currselectedOption == "I'm from Zypharion.")
                {
                    DP1_6 = true;
                    StartCoroutine(dialogueManager.LoadAndStartDialoguesSequentially(new string[] { "W1D1.4" }));
                }
